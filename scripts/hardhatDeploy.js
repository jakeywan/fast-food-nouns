async function main() {
  ...
  const setDescriptor = await nounsToken.setDescriptor(ffnDescriptor.address, {
    from: testAccounts[0],
    gasLimit: 250000
  })
