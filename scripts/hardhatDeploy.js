async function main() {
  ...
  const nounsToken = await NounsToken.deploy(nounsDescriptor.address);

  console.log('NOUNSTOKEN DEPLOYED TO', nounsToken.address);
  console.log('NOUNSDESCRIPTOR DEPLOYED TO', nounsDescriptor.address);

  // Populate palettes into descriptor (required for tokenURI)
  await nounsDescriptor.addManyColorsToPalette(0, colors);
