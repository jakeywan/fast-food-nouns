...
/// 1. We're referencing the deployed INounsDescriptor so that we can pull SVG
/// parts from their (otherwise we'd have to populate our own again).
/// 2. For body, accessories, etc. we're referencing the deployed descriptor
/// instead of our own internal state.
/// 3. We included the referenced libraries in the same file. Easier than linking.
/// 4. We left the unused functions so that this contract conforms to the interface
...
contract NounsDescriptor is INounsDescriptor, Ownable {
    ...
    // MAINNET
    INounsDescriptor public descriptor = INounsDescriptor(0x0Cfdb3Ba1694c2bb2CFACB0339ad7b1Ae5932B63);
    // RINKEBY
    // INounsDescriptor public descriptor = INounsDescriptor(0x53cB482c73655D2287AE3282AD1395F82e6a402F);
